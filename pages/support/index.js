...
const SECTION_DEFINITIONS = [
  ...
  { key: "stock", label: "Stock & Inventory", keywords: ["stock", "inventory", "product", "restock", "stock take", "expiry", "fifo", "batch", "operational loss", "category", "pack", "location stock"] },
  { key: "procurement", label: "Procurement", keywords: ["vendor", "supplier", "purchase order", "payment tracker", "receive"] },
  { key: "reporting", label: "Reporting & EOD", keywords: ["report", "sales report", "sales total", "discount", "refund", "completed transactions", "end of day", "eod", "employees", "locations", "categories"] },
