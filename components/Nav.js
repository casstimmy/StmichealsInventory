      ...
      <aside className="fixed top-16 left-0 w-20 h-screen bg-gradient-to-b from-gray-50 to-gray-100 border-r border-gray-200 z-10 shadow-lg hidden md:block overflow-visible">
        <nav className="h-full overflow-visible flex flex-col">
          ...
          <ul className="space-y-1 mt-2 flex-1">
            ...
            {/* Manage */}
            <li className={`${pathname.startsWith("/manage") ? activeLink : baseLink} relative`}>
              <div
                className="flex flex-col items-center justify-center cursor-pointer"
            ...
            {/* Stock */}
            <li className={`${pathname.startsWith("/stock") ? activeLink : baseLink} relative`}>
              <div
                className="flex flex-col items-center justify-center cursor-pointer"
                ...
                <ul className="bg-gray-50 border-l-4 border-blue-600">
                  ...
                  <li onClick={closeMenu}>
                    <Link
                      ...
                      className={`block px-8 py-3 text-sm transition-all ${
                        pathname === "/setup/Hero-Promo-setup"
                          ? "bg-blue-50 text-blue-700 font-semibold border-l-4 border-blue-600"
                          : "text-gray-700 hover:bg-blue-50 hover:text-blue-600 border-l-4 border-transparent"
                      }`}
                    >
                  ...
                  <li onClick={closeMenu}>
                    <Link
                      href="/setup/pos-tenders"
                      className={`block px-8 py-3 text-sm transition-all ${
                        pathname === "/setup/pos-tenders"
                          ? "bg-blue-50 text-blue-700 font-semibold border-l-4 border-blue-600"
                          : "text-gray-700 hover:bg-blue-50 hover:text-blue-600 border-l-4 border-transparent"
                      }`}
                    >
                ...
                <ul className="bg-gray-50 border-l-4 border-blue-600">
                  ...
                  <li onClick={closeMenu}>
                    <Link
                      ...
                      className={`block px-8 py-3 text-sm transition-all ${
                        pathname === "/manage/promotions-management"
                          ? "bg-blue-50 text-blue-700 font-semibold border-l-4 border-blue-600"
                          : "text-gray-700 hover:bg-blue-50 hover:text-blue-600 border-l-4 border-transparent"
                      }`}
                    >
                  ...
                  <li onClick={closeMenu}>
                    <Link
                      ...
                      className={`block px-12 py-3 text-sm transition-all ${
                        pathname === "/manage/customer-search"
                          ? "bg-blue-50 text-blue-700 font-semibold border-l-4 border-blue-600"
                          : "text-gray-700 hover:bg-blue-50 hover:text-blue-600 border-l-4 border-transparent"
                      }`}
                    >
                ...
                <ul className="bg-gray-50 border-l-4 border-blue-600">
                  ...
                  <li onClick={closeMenu}>
                    <Link
                      ...
                      className={`block px-8 py-3 text-sm transition-all ${
                        pathname === "/stock/expiration-report"
                          ? "bg-blue-50 text-blue-700 font-semibold border-l-4 border-blue-600"
                          : "text-gray-700 hover:bg-blue-50 hover:text-blue-600 border-l-4 border-transparent"
                      }`}
                    >
                ...
                <ul className="bg-gray-50 border-l-4 border-blue-600">
                  ...
                  <li onClick={closeMenu}>
                    <Link
                      ...
                      className={`block px-8 py-3 text-sm transition-all ${
                        pathname === "/reporting/end-of-day-report"
                          ? "bg-blue-50 text-blue-700 font-semibold border-l-4 border-blue-600"
                          : "text-gray-700 hover:bg-blue-50 hover:text-blue-600 border-l-4 border-transparent"
                      }`}
                    >
            ...
            <li>
              ...
              {openMenu === "expenses" && (
                <ul className="bg-gray-50 border-l-4 border-blue-600">
                  ...
                  <li onClick={closeMenu}>
                    <Link
                      href="/expenses/tax-analysis"
                      className={`block px-8 py-3 text-sm transition-all ${
                        pathname === "/expenses/tax-analysis"
                          ? "bg-blue-50 text-blue-700 font-semibold border-l-4 border-blue-600"
                          : "text-gray-700 hover:bg-blue-50 hover:text-blue-600 border-l-4 border-transparent"
                      }`}
                    >
                  ...
                  <li onClick={closeMenu}>
                    <Link
                      ...
                      className={`block px-8 py-3 text-sm transition-all ${
                        pathname === "/expenses/tax-personal"
                          ? "bg-blue-50 text-blue-700 font-semibold border-l-4 border-blue-600"
                          : "text-gray-700 hover:bg-blue-50 hover:text-blue-600 border-l-4 border-transparent"
                      }`}
                    >
